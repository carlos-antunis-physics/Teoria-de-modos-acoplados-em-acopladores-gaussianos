...
axs = [
    Axis(fig[1, 1], title = L"\Psi_a(\mathbf{r}_\perp)"),
    Axis(fig[1, 2], title = L"\Psi_b(\mathbf{r}_\perp)"),
];
...
fig = Figure(size=(800, 400));
axs = [
    Axis(fig[1, 1], title=L"\Psi(\mathbf{r}_\perp, 0\mu m) = \Psi_a(\mathbf{r}_\perp)"),
    Axis(fig[1, 2], title=L"\Psi(\mathbf{r}_\perp, 0\mu m) = \Psi_b(\mathbf{r}_\perp)"),
];
